...
extern int	FileRead(File file, char *buffer, off_t offset, int amount, uint32 wait_event_info);
extern int	FileWrite(File file, char *buffer, off_t offset, int amount, uint32 wait_event_info);
